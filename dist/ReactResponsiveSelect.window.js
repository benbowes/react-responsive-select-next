window.ReactResponsiveSelect = (function(e) {
  var t = {};
  function n(r) {
    ...
    (function(e, n) {
      ...
      (M['[object Float32Array]'] = M['[object Float64Array]'] = M[
        ...
        (M[u] = M[s] = M[I] = M[d] = M[T] = M[f] = M[p] = M[S] = M[v] = M[
          b
        ] = M[h] = M[m] = M[g] = M[x] = M['[object WeakMap]'] = !1);
      ...
      function Le(e, t, n, r, o, i) {
        ...
        for (i.set(e, t), i.set(t, e); ++f < s; ) {
          ...
          if (S) {
            if (
              !H(t, function(e, t) {
                if (!U(S, t) && (_ === e || o(_, e, n, r, i))) return S.push(t);
              })
            ) {
              p = !1;
              break;
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        ...
        if (i) return;
        n.updateState({
          type: o.SET_NEXT_SELECTED_INDEX,
          optionIndex: (0, r.default)(l, t),
        }),
          !1 === a && n.updateState({ type: o.SET_OPTIONS_PANEL_OPEN });
      });
    var r = (function(e) {
    ...
    t.default = function(e) {
      ...
      if (!s) {
        ...
        (c[d] && !0 === c[d].disabled) ||
          ...
          i ? t.stopPropagation() : o.onSubmit());
      }
    };
  },
  function(e, t, n) {
        ...
        if (!1 === u) {
          ...
          if ((0, r.default)(t.target, 'rrs__option'))
            return void l.updateState({
              type: a ? o.SET_MULTISELECT_OPTIONS : o.SET_SINGLESELECT_OPTIONS,
              optionIndex: d,
            });
          l.updateState(
            { type: i ? o.SET_OPTIONS_PANEL_CLOSED : o.SET_OPTIONS_PANEL_OPEN },
            function(e) {
              !1 === e.isOptionsPanelOpen && l.focusButton();
            },
          );
        }
      });
  ...
  function(e, t, n) {
    ...
    (t.multiSelectBroadcastChange = r.default),
      (t.singleSelectBroadcastChange = o.default);
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
        ...
        r(t, [
          {
            ...
            value: function() {
              var e = this.props,
                ...
                o = e.optionsContainerRef,
                l = e.optHeaderLabel;
              t === r &&
                n &&
                (l && o.current.scroll(0, -1e4),
  ...
  function(e, t, n) {
    ...
    var c = (function(e) {
      function t() {
        ...
        return (
          (e.optionsButton = l.default.createRef()),
          (e.optionsContainer = l.default.createRef()),
          e
        );
      }
      return (
        ...
        r(t, [
          {
            ...
            value: function() {
              var e = this.props,
                ...
                o = e.optionsContainerRef,
                l = e.optHeaderLabel;
              if (t === r && n && (this.optionRef.current.focus(), l)) {
                var a = Math.ceil(
                  this.optionRef.current.getBoundingClientRect().top -
                ...
                (this.scrollOffset =
                  ...
                  a < this.scrollOffset &&
                    o.current.scroll(
                      0,
                      Math.floor(o.current.scrollTop - this.scrollOffset),
                    );
              }
            },
          },
            ...
            value: function() {
              ...
              return l.default.createElement(
                'li',
                {
                  ...
                  'aria-label':
                    '\n        ' +
                    (o.text || (o.markup && o.markup.textNode)) +
                    ' ' +
                    ('' !== i ? ' of ' + i : '') +
                    '\n      ',
                  'aria-live': 'assertive',
                  'aria-disabled': this.isDisabled(o) ? 'true' : 'false',
                  'data-key': t,
                  index: t,
                  ref: this.optionRef,
                  className: (0, a.default)(
  ...
  function(e, t, n) {
    ...
    (t.default = c), (c.propTypes = i.MultiSelectProps);
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
      ...
      return r({}, e, {
        multiSelectSelectedIndexes: [].concat(
          (function(e) {
            ...
            return Array.from(e);
          })(o.default.multiSelectSelectedIndexes),
        ),
        multiSelectSelectedOptions: r({}, o.default.multiSelectSelectedOptions),
      });
    };
    var o = (function(e) {
      return e && e.__esModule ? e : { default: e };
  ...
  function(e, t, n) {
    ...
    (t.getSelectedValueIndex = r.default),
      (t.getMultiSelectSelectedValueIndexes = o.default),
  ...
  function(e, t, n) {
    ...
    t.default = function(e, t) {
      switch (t.type) {
        ...
        case o.SET_IS_DRAGGING:
          return r({}, e, { isDragging: t.value });
        case o.SET_OPTIONS_PANEL_OPEN:
          var u = r({}, e, {
            isOptionsPanelOpen: !0,
            nextPotentialSelectionIndex: e.multiselect
              ? e.multiSelectSelectedIndexes.length
                ? (0, l.nextValidIndex)(e, e.multiSelectSelectedIndexes[0])
                : (0, l.nextValidIndex)(e, 0)
              : (0, l.nextValidIndex)(e, e.nextPotentialSelectionIndex),
            singleSelectSelectedOption: (0, a.getSingleSelectSelectedOption)(
              e,
              e.nextPotentialSelectionIndex,
            ),
        ...
        case o.SET_OPTIONS_PANEL_CLOSED:
          var s = r({}, e, {
            isOptionsPanelOpen: !1,
        ...
        case o.SET_OPTIONS_PANEL_CLOSED_NO_SELECTION:
        case o.SET_OPTIONS_PANEL_CLOSED_ONBLUR:
          return r({}, e, { isOptionsPanelOpen: !1 });
        case o.SET_NEXT_SELECTED_INDEX:
          return r({}, e, {
        ...
        case o.SET_NEXT_SELECTED_INDEX_ALPHA_NUMERIC:
          return r({}, e, {
            isOptionsPanelOpen: !0,
            nextPotentialSelectionIndex: t.optionIndex,
          });
        case o.SET_SINGLESELECT_OPTIONS:
          var c = r({}, e, {
            nextPotentialSelectionIndex: t.optionIndex,
        ...
        case o.SET_MULTISELECT_OPTIONS:
          if (!e.noSelectionLabel) {
            var d =
          ...
          e.noSelectionLabel &&
            e.multiSelectSelectedOptions.options[0].text ===
              e.noSelectionLabel &&
            (e.multiSelectSelectedOptions.options = []);
          var _ = (0, l.nextValidIndex)(e, t.optionIndex),
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        var t = e.state,
          ...
          o = t.isDragging;
        if (t.disabled) return;
        o || n.updateState({ type: r.SET_IS_DRAGGING, value: !0 });
      });
    var r = (function(e) {
      if (e && e.__esModule) return e;
      var t = {};
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e, t) {
        var n = t.isOptionsPanelOpen,
          o = t.nextPotentialSelectionIndex,
          l = t.options;
        switch (e) {
          case 'INCREMENT':
            return !1 === n
              ? (0, r.nextValidIndex)(t, o, 'INCREMENT')
              : o === l.length - 1
                ? (0, r.nextValidIndex)(t, 0, 'INCREMENT')
                : (0, r.nextValidIndex)(t, o + 1, 'INCREMENT');
          case 'DECREMENT':
            return !1 === n
              ? (0, r.nextValidIndex)(t, o, 'DECREMENT')
              : 0 === o
                ? (0, r.nextValidIndex)(t, l.length - 1, 'DECREMENT')
                : (0, r.nextValidIndex)(t, o - 1, 'DECREMENT');
          default:
        ...
        switch (t.keyCode) {
          case r.default.TAB:
            p &&
              (t.preventDefault(),
              f &&
                d.updateState({ type: o.SET_OPTIONS_PANEL_CLOSED }, function() {
          ...
          case r.default.SPACE:
            p
              ...
              : d.updateState({ type: o.SET_OPTIONS_PANEL_OPEN });
            break;
          case r.default.ESCAPE:
            d.updateState(
              { type: o.SET_OPTIONS_PANEL_CLOSED_NO_SELECTION },
              function() {
                return d.focusButton();
              },
            );
  ...
  function(e, t, n) {
    ...
    t.default = function(e, t, n, o) {
      o &&
        (!(0, r.default)(e, t) &&
          o({ name: t.name, text: t.text, value: t.value, altered: n }));
    };
  },
  function(e, t, n) {
    'use strict';
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function(e) {
        ...
        p &&
          d &&
          (f
            ? (0, o.multiSelectBroadcastChange)(void 0, c.options, u, d)
            : (0, o.singleSelectBroadcastChange)(void 0, s, u, d));
      });
    var r = (function(e) {
        if (e && e.__esModule) return e;
        var t = {};
          ...
          },
          {
            ...
            value: function() {
              var e = this,
                ...
                l = this.state,
                i = l.altered,
                s = l.singleSelectInitialIndex,
                d = l.hasOptHeaders,
                f = l.isOptionsPanelOpen,
                p = l.isDragging,
                _ = l.noSelectionLabel,
                v = l.multiSelectInitialSelectedIndexes,
                h = l.multiSelectSelectedIndexes,
                y = l.multiSelectSelectedOptions,
                m = l.name,
                g = l.nextPotentialSelectionIndex,
                x = l.options,
                P = l.singleSelectSelectedIndex,
                E = l.singleSelectSelectedOption,
                I = l.multiselect,
